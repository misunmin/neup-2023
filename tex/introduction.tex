...
and the FOM.  As a step toward pMOR for 3D reactor analysis, We explore
error-indicated pMOR in depth for high Rayleigh-number two-dimensional slot
convection in \cite{tsai22a} (work that was also supported under 18-15520).  
