...
(SFR) fuel assemblies under steady-state and transient conditions and extend to
upper plenum applications as a stretch goal. 
\textbf{We emphasize that the methods developed will apply to a broad range of
advanced reactor applications.} To maximize impact, we will integrate the
proposed multi-scale approaches in the Cardinal \cite{cardinal} framework thus
allowing their usage in SAM \cite{hu2021}. 
